# Poké Strikers — Stadium League

A single-file, browser-based Pokémon-inspired penalty shootout game designed for both mobile and desktop play.

## Play

Open `pokemon fifa.html` in a modern browser, or serve the repository with a small static server:

```bash
python3 -m http.server 8000
```

Then visit `http://localhost:8000/pokemon%20fifa.html`.
